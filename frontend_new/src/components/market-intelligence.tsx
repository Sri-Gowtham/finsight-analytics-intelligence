...
function parsePrice(raw: unknown): number {
  ...
  if (typeof raw === "object" && raw !== null) {
    const obj = raw as { [key: string]: string };
    const nse = obj["NSE"] ?? obj["BSE"] ?? "0";
    return parseFloat(nse.replace(/,/g, "")) || 0;
  }
  return 0;
}
...
export function MarketOverviewPanel() {
  ...
  console.log('[MarketOverview] data:', data, 'isPending:', isPending, 'isError:', isError);
